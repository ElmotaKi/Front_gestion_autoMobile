...
const DemoPagePneumatiquechange = () => {
    ...
    const PneuChangé = pneumatiquesdata ? pneumatiquesdata.filter(pneu => pneu.Date_Changement !== null) : [];
    ...
    return (
        <div className="container mx-auto py-10">
            <DataTable columns={columns} data={PneuChangé} onDeleteSuccess={onDeleteSuccess} />
        </div>
    );
...
export default DemoPagePneumatiquechange;
